...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($no_of_row > 0) {
        ...
        $insert_query = "
		INSERT INTO anggota
		(namaAnggota, email, password, kode_aktivasi)
		VALUES (:user_name, :user_email, :user_password, :user_activation_code)
		";
        ...
        if(isset($result)) {
            try {
                $base_url = "http://192.168.43.88/sikeu/api/";  //change this baseurl value as per your file path
                $mail_body = '<!doctype html>
<html lang="en">
<head>
    <meta name="viewport" content="width=device-width">
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Email Verification SI-TAKESI</title>
    <style>
    ...
    <tr>
        ...
        <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; Margin: 0 auto; max-width: 580px; padding: 10px; width: 580px;">
            <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 580px; padding: 10px;">
                ...
                <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Thanks for Registration.</span>
                <table class="main" style="border-collapse: separate; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%; background: #ffffff; border-radius: 3px;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%;">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px;">Hi '.$nama.',</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px;">Thanks for Registration. Your SI-TAKESI account will work only after your email is verified.</p>
                                            ...
                                            <tr>
                                                <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">
                                                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0; mso-table-rspace: 0; width: auto;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;"> <a href="'.$base_url.'email_verification.php?activation_code='.$user_activation_code.'" target="_blank" style="display: inline-block; color: #ffffff; background-color: #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border: 1px solid #3498db;">Click to Verify</a> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0 0 15px;">Best Regards, <br>Admin</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0; mso-table-rspace: 0; width: 100%;">
                        <tr>
                            <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                                <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Zeecodeku Dev, Jln Veteran Kec. Purwakarta - 41115</span>
                                <br>Purwakarta, Jawa Barat, Indonesia.
                            </td>
                        </tr>
                        <tr>
        ...
        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">&nbsp;</td>
                ...
                $mail->Subject = 'Email Verification SI-TAKESI';		//Sets the Subject of the message
...
//    $email = $_POST["email"];
//    $password = $_POST["password"];
//    $query = "INSERT INTO anggota (namaAnggota,email,password) VALUES ('$nama','$email','$password')";
//
